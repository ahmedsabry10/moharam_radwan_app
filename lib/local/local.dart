...
class MyLocale implements Translations{
  ...
  Map<String, Map<String, String>> get keys => {
    "ar":{
      ...
      "content1": "اكتشف أفق التصميم الإبداعي: خدمات تصميم المواقع لدينا تمنحك تجربة فريدة من نوعها، حيث يتم دمج الجمال بالأداء لإنشاء تجربة مستخدم لا تُنسى",
      "client":"عملاءنا: إلهامنا من قصص نجاح شركائنا",
      "content2":"انضم إلى عملائنا الراضين: دمج التكنولوجيا بالإبداع لنقدم لك تجارب رقمية لا مثيل لها. اتصل بنا اليوم لتحويل رؤيتك إلى واقع رقمي متميز",
      "wordpress":"خدمات ووردبريس",
      "graphic":"خدمات تصميم الجرافيك",
      "marketing":"خدمات التسويق",
      "content3":"رؤية رقمية، تجربة استثنائية، نحن محرم رضوان",
      "best_offers":"أفضل العروض",
      "content4":"اختر أفضل الباقات المناسبة لك",
      "opinions":"اراء العملاء",
      "content5":"نحن في محرم رضوان نفخر بتقديم خدمات تقنية متقدمة تشمل تصميم المواقع وتصميم الجرافيك. نقدم حلولًا رقمية مبتكرة تلبي احتياجات العملاء وتساهم في تعزيز تواجدهم الرقمي.",
      "subscribe":"اشترك الآن",
      "content6":"نضع الإبداع في قلب أعمالنا، حيث نسعى لتقديم تصاميم فريدة تعكس هوية عملائنا",
      "order_now":"اطلب الآن",
      "header1":"عن محرم رضوان للحلول الرقميَّة و تكنولوجيا المعلومات",
      "content_for_header1":"نسعى لتحويل التحديات إلى فرص من خلال تقديم حلول رقمية متقدمة تسهم في تحقيق أهداف عملائنا",
      "content2_for_header1":"شركة محرم رضوان للحلول الرقمية وتكنولوجيا المعلومات هي منظمة تعمل في مجال توفير حلول متقدمة ومتكاملة في مجال التكنولوجيا والمعلومات. تهدف هذه الشركات إلى تلبية احتياجات الأعمال والمؤسسات من خلال تقديم خدمات متخصصة في تطوير البرمجيات، وتصميم المواقع الإلكترونية، وإدارة الشبكات، وتحليل البيانات، والأمان السيبراني، والابتكار التكنولوجي.",
      "content3_for_header1":"تعتبر شركتنا جزءًا أساسيًا من البنية التحتية للأعمال الحديثة، حيث تساهم في تعزيز الكفاءة وزيادة التنافسية من خلال تكامل التقنيات الحديثة. تقوم شركات حلول رقمية بفحص الاحتياجات الفردية لعملائها وتقديم حلاً مخصصًا يتناسب مع أهدافهم الاستراتيجية.",
      ...
      "services2":"مواقع إلكترونية",
      "services3":"محركات البحث",
      "services4":"متاجر إلكترونية",
      "services5":"تسويق رقمى",
      "services6":"البرمجيات ",
      "services7":"حملات إعلامية",
      "services8":"تصميم جرافيك",
      "services9":"إنتاج إعلامي",
      ...
      "distinguishes_title1":"تطوير تطبيقات الهاتف الذكى",
      "distinguishes_title2":"برمجة الواجهة الخلفية",
      "distinguishes_title3":"اختبار وتحسين الأداء",
      "distinguishes_content1":"نقدم تطويرا متقدما لتطبيقات ios و android , مع التركيز على أداء عالى وتوافق مع محتلف الأجهزة",
      "distinguishes_content2":"نضمن تصميم وبرمجة واجهة خلفية فعالة للتطبيق, تدعم إدارة البيانات بكفاءة وتمكين التفاعل بين التطبيق وقواعد البيانات",
      "distinguishes_content3":"نقوم بتنفذ اختبارات شاملة لضمان أمان التطبيق واستقراره, ونعمل على تحسين الأداء بشكل دوري",
      "maintenance_services":"خدمات الدعم والصيانة",
      "maintenance_title1":"اختبار وتحسين الأداء",
      "maintenance_title2":"دعم فنى",
      "maintenance_content1":"توفر خدمات الصيانة المستمرة وتحديثات الأمان لضمان استمرار توافق التطبيق مع التطورات التكنولوجية",
      "maintenance_content2":"نقدم دعما فنيا مستمرا للتعامل مع آية تحديات او مشاكل تواجه مستخدمى التطبيق",
      "applications_we_designed":"تطبيقات صممناها",
      ...
      "dynamic_website":"تطوير مواقع الويب الديناميكية",
      "web_distinguishes_content1":"نحن نسعي لتحسين تجربة المستخدم عبر واجهات متقنة , مع التركيز على التفاعل السلس والتنقل السهل",
      "web_distinguishes_content2":"نقوم بتطوير مواقع ويب ديناميكية متطورة باستخدام تقنيات حديثة ,  مما يتيح لك إدارة محتوى موقعك بكفاءة",
      "web_distinguishes_content3":"نقوم بتنفيذ اختبارات شامله لضمان أمان الموقع واستقراره , ونعمل على تحسين الأداء بشكل دوري",
      "database_integration":"تكامل قواعد البيانات",
      "improve_site_performance":"تحسين أداء الموقع",
      "database_integration_c1":"نقدم حلا شاملا لتكامل قواعد البيانات مع موقعك , مما يمكنك من إدارة بياناتك بكفاءه وفعالية",
      "improve_site_performance_c1":"نقدم دعما فنياََ مستمراََ للتعامل مع آية تحديات أو مشاكل  تواجه مستخدم الموقع",


      ///تحسين محركات البحث
      "engine_optimization_title":"نقدم خدمات SEO المتقدمة: زيادة رؤية موقعك وتحسين تصنيفاته",
      "engine_optimization_content1":"في عصر الإنترنت اليوم، يعد تحسين محركات البحث (SEO) حجر الزاوية لضمان أن يتم اكتشاف موقعك بشكل فعال ويظهر بشكل متقدم في نتائج البحث. تقدم خدماتنا المتخصصة في SEO حلاً شاملاً لتعزيز رؤية موقعك وتحسين موقعه فى ترتيب محركات البحث.",
      "keyword_analysis":"تحليل الكلمات الرئيسية",
      "keyword_analysis_content":"نقوم باجراء تحليل شامل للكلمات الرئيسية المرتبطة بنشاطك التجاري لتحديد الكلمات الأكثر فاعلية فى تحسين ترتيب موقعك",
      "linking_security":"أمان الربط وبناء الروابط",
      "linking_security_content":"نقوم بتنفيذ استراتيجيات بناء الروابط بشكل آمن وفعال لتعزيز السمعة الرقمية لموقعك وتحسين موقعه فى نتائج البحث ",
      ...
      "content_management_system":"نظام إدارة محتوي فعال ",
      "content_management_system_content":"نقدم أنظمة إدارة محتوى (CMS) قوية تتيح لك إدارة المنتجات وتحديثات الموقع بكفاءة",
      "improve_transaction_security":"تحسين أمان المعاملات",
      "improve_transaction_security_content":"نقوم بتكامل طبقات إضافية من الأمان لحماية المعلومات الحساسة للعملاء أثناء عمليات الدفع",
      ...
      "com_digital_marketing_content":"نقدم حلول تسويقية متكاملة تغطي كافة جوانب الوجود الرقمي , من تصميم المواقع وتحسين محركات البحث الى إدارة وسائل التواصل الاجتماعي والحملات الاعلانيه عبر الانترنت ",
      ...
      "unique_strategy_content":"نقدم استراتيجيات تسويقية معدة خصيصاََ لاحتياجات كل عميل , مما يضمن تحقيق أقصي قدر من الفاعلية والتأثير",
      ...
      "dedicated_team_content":"يضم فريقنا خبراء فى مجالات التسويق الرقمي وتحليل البيانات , مما يمنح عملائنا الثقة في تحقيق أفضل النتائج.",
      "numbers_achieved":"أرقام حققناها",
      ...
      "visual_identity_design_content":"نقدم خدمات تصميم شاملة للهوية البصرية , بدءاََ من انشاء شعارات مميزة إلي ابتكار تصاميم تعبيرية للواجهات الرقمية والمطبوعات .",
      "Website_application_design":"تصميم المواقع والتطبيقات",
      "Website_application_design_content":"يعمل فريقنا علي تحسين تجربة المستخدم من خلال تصميم واجهات مستخدم جذابة ووظيفة للمواقع والتطبيقات.",
      "marketing_materials_design":"تصميم المواد التسويقية",
      "marketing_materials_design_content":"نقدم تصميما احترافياََ للمواد التسويقية مثل البنرات الأعلانية , والكتيبات , لتعزيز تواجد علامتك التجارية بشكل فعال.",
      "unique_creativity":"إبداع فريد",
      "unique_creativity_content":"نحن نضع الإبداع في قلب كل تصميم نقوم به مع التركيز علي تقديم أعمال فنية تتميز بالتميز والابتكار",
      ...
      "interaction_with_the_customer_content":"نحن نفهم  أهمية التواصل الفعال مع عملائنا . لذا , نسعي دائما لفهم رؤيتك وتحويلها إلى تصاميم واقعية تعكس هويتك.",
      ...
      "video_production":"إنتاج الفديو",
      "video_production_content":"من إنتاج الفديو الترويجي إلي الوثائقيات , نقدم حلولا متكاملة لتلبية احتياجاتك , فريق الإنتاج لدينا يعمل علي تحويل أفكارك إلي قصص بصرية مذهلة.",
      "audio_production":"الإنتاج الصوتي",
      "audio_production_content":"نحن نقدم خدمات إنتاج صوتي تشمل تسجيل الأصوات , إنتاج بودكاست , وخلق تجارب صوتية فريدة لتعزيز تواجدك الأعلامي",
      "photographic_development":"التطوير الفوتوغرافي",
      "photographic_development_content":"من تصوير المنتجات إلي التصوير الفوتوغرافي الفني , نقدم خدمات التصوير لتلبية احتياجات التسويق والتوثيق.",
      ...
      "advanced_technology":"تقنية متقدمة",
      "advanced_technology_content":"تستخدم أحدث التقنيات في عمليات الإنتاج لضمان جودة عالية وتحقيق تأثير بصري وسمعي مميز.",
      "interaction_with_customer":"التفاعل مع العميل",
      "interaction_with_customer_content":"نحن نفهم أهمية التواصل الفعال مع عملائنا . لذا , نسعى دائماََ رؤيتك وتحويلها إلى تصاميم واقعية تعكس هويتك.",


      ///dashboard
      "dashboard":"لوحة التحكم",
      "control_best_offers":"التحكم في أفضل العروض",
      "control_best_packages":"التحكم في أفضل الباقات",
      "add_new_offer":"إضافه عرض جديد",
    ...
    "en":{
      ...
      "content1": "Discover the creative design horizon: Our website design services give you a unique experience, where beauty and performance are combined to create an unforgettable user experience.",
      "client":"Our customers: our inspiration from our partners' success stories",
      "content2":"Join our satisfied customers: fusing technology with creativity to deliver unparalleled digital experiences. Contact us today to turn your vision into an outstanding digital reality",
      "wordpress":"Wordpress service",
      "graphic":"Graphic design services",
      "marketing":"Marketing services",
      "content3":"Digital vision, exceptional experience, we are Moharam Radwan ",
      "best_offers":"Best Offers",
      "content4":"Choose the best packages suitable for you",
      "opinions":"Customer opinions",
      "content5":"We at Moharam Radwan are proud to provide advanced technical services that include website design and graphic design. We provide innovative digital solutions that meet customers' needs and contribute to enhancing their digital presence.",
      "subscribe":"Subscribe now",
      "content6":"We put creativity at the heart of our work, as we strive to provide unique designs that reflect the identity of our customers.",
      "order_now":"Order Now",
      "header1":"About Moharam Radwan for digital solutions and information technology",
      "content_for_header1":"We seek to transform challenges into opportunities by providing advanced digital solutions that contribute to achieving our customers’ goals",
      "content2_for_header1":"Moharam Radwan  Company for Digital Solutions and Information Technology is an organization working in the field of providing advanced and integrated solutions in the field of technology and information. These companies aim to meet the needs of businesses and organizations by providing specialized services in software development, website design, network management, data analysis, cybersecurity, and technological innovation.",
      "content3_for_header1":"Our company is an essential part of the modern business infrastructure, contributing to enhancing efficiency and increasing competitiveness through the integration of modern technologies. Digital solutions companies examine the individual needs of their customers and provide a customized solution that fits their strategic goals.",
      "our_customers":"Out Customers",
      "whatsapp":"Whatsapp",
      "tik_tok":"TikTok",
      "facebook":"Facebook",
      "instagram":"Instagram",
      ...
      "distinguishes_title1":"Smart phone application development",
      "distinguishes_title2":"Backend programming",
      "distinguishes_title3":"Test and improve performance",


      "distinguishes_content1":"We provide advanced development for iOS and Android applications, focusing on high performance and compatibility with various devices",
      "distinguishes_content2":"We ensure the design and programming of an effective back-end interface for the application, which supports efficient data management and enables interaction between the application and databases",
      "distinguishes_content3":"We carry out comprehensive tests to ensure the security and stability of the application, and we work to improve performance periodically",

      "maintenance_services":"Support and maintenance services",
      "maintenance_title1":"Test and improve performance",
      "maintenance_title2":"Technical Support",
      "maintenance_content1":"Provides ongoing maintenance services and security updates to ensure the application remains compatible with technological developments",
      "maintenance_content2":"We provide ongoing technical support to deal with any challenges or problems facing application users",
      ...
      "dynamic_website":"Dynamic website development",

      "web_distinguishes_content1":"We seek to improve the user experience through sophisticated interfaces, focusing on smooth interaction and easy navigation",
      "web_distinguishes_content2":"We develop advanced, dynamic websites using modern technologies, allowing you to manage your site content efficiently",
      "web_distinguishes_content3":"We carry out comprehensive tests to ensure the security and stability of the website, and we work to improve performance periodically",
